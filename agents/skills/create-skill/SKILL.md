...
| Type | Path | Scope |
|------|------|-------|
| Personal | $SKILLS_PATH/skill-name/ | Available across all your projects |
| Project | .(cursor|claude|agent|agents)/skills/skill-name/ | Shared with anyone using the repository |
