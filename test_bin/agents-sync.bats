...
@test "removing a source agent deletes its previously generated file on the next run" {
...
@test "a destination file never generated by agents-sync is left alone during pruning" {
  write_named_agent_source agent-a
  run_sync
  [ -f "$DEST/agent-a.md" ]
