...
local highlights = {
  ...
  Cursor = { bg = palette.color16, fg = color0 },
  ...
  WildMenu = { bg = palette.color12, fg = palette.bg },
  ...
  IncSearch = { fg = palette.color12, bg = palette.color4, underline = true },
  Search = { fg = palette.bg, bg = palette.color6 },
  CurSearch = { fg = palette.bg, bg = palette.color14 },
  -- Gutter
  ...
  DiffAdd = { bg = utils.blend_colors(palette.color14, palette.bg, 0.75) },
  DiffChange = { bg = utils.blend_colors(palette.color11, palette.bg, 0.75) },
  DiffDelete = { fg = palette.color7, bg = utils.blend_colors(palette.color9, palette.bg, 0.75) },
  ...
  TelescopeResultsNormal = { fg = palette.gray5, bg = palette.color00 },
