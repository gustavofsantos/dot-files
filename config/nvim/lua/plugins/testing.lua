...
return {
  {
    ...
    config = function()
      ...
      if is_beyond_py() then
        ...
        vim.cmd([[let test#python#pytest#options = "-x --disable-warnings -q --pdb --ds beyond_app.settings.test"]])
      ...
      elseif is_loggiweb() then
        ...
        vim.cmd([[let test#python#pytest#options = "-x --disable-warnings -q --pdb --ds settings.test"]])
      end
    end,
  },
}
